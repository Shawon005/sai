  ...
  <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Create New Speltip</h4>
                        <h6 class="card-subtitle">made with bootstrap elements</h6>
                        <form class="floating-labels m-t-40" action="{{route('admin.speltip.store')}}" method ="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group m-b-40">
                                
                                <input type="text" class="form-control" id="exampleInputuname1" name="question" >
                                <label for="exampleInputuname1">Question</label>
                            </div>
                            <div class="form-group m-b-40">
                                <label for="exampleInputuname1">Answer</label><br><br>
                                <textarea id="mymce" name="answer"></textarea>
