            ...
            <span class="icon icon-corporate1 fa fa-info" title="Lorem, ipsum dolor sit amet  animi? Officiis accusamus numquam eos totam sit?"></span>
                <div class="row" class="text-center">
                    <div class="col-6">
                        ...
                        <input type="text"value="345660 kr"readonly class="form-control">
                       
                    </div>
                    <div class="col-6">
                        <span class="text-center">Jackpot</span>
                        <input type="text"value="0 kr"readonly class="form-control">
                    </div>
                </div>
            </div>
            <div style="background-color: #393b3d;"class="p-4 m-2 rounded-3">
                ...
                <div class="row" class="text-center">
                    <div class="col-4">
                        ...
                        <select name="" id=""class=" me-2"style="line-height: 0.3; width:30px">
                    ...
                    <div class="col-4">
                        ...
                        <select name="" id=""cclass=" me-2"style="line-height: 0.3; width:30px">
                            <option value="" seletecd>12</option>
                            <option value="">34</option>
                            <option value="">45</option>
                        </select>
            ...
            <div class="text-white">
                <div class="row">
                    ...
                    <div class="col-5 text-end">
                        <button class="btn btn-primary">adsfsdf</button> <button class="btn btn-primary">adsfsdf</button>
                    </div>
                </div>
