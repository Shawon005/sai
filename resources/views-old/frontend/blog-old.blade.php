                ...
                <div class="row " style="margin-top:10px">
                  ...
                  <div class="col-lg-8" >
                    ...
                    <div class="post-miranda-text clr-7">
                     <p>{{ Str::limit(strip_tags($blog->blog_description),270) }}</p>
                    </div>
                  </div>
                </div>
              </article> 
