        ...
        <div class="footer-classic-main">
          <div class="container">
            <div class="row row-30 ">
              ...
              <div class="col-lg-3">
                <p class="heading-7" style="font-weight:700">Social Medier</p>
                <ul class="list-unstyled">
                  ...
                  <li><a class="icon icon-corporate fa fa-linkedin" target="_blank" href="{{$setting->youtube}}"><span class="text-new"> LinkedIn </span></a></li>
                  <li><a class="icon icon-corporate fa fa-twitch" target="_blank" href="{{$setting->twich}}"><span class="text-new"> Twich</span></a></li>
                </ul>
              </div>
              <div class="col-lg-3">
                <p class="heading-7" style="font-weight:700">Vilikor Och</p>
                <ul class="list-unstyled">
                  ...
                  <div class="container text-center">
                    <div class="row" style="border-bottom:none; margin-left: 10%;">
                      <div class="col-lg-4 col-sm-12 company-logos logos">
                        <img src="{{$setting->footer_image1}}" alt="alibaba"style="width: 80%;height: 52.5px;"  >
                        </div>
                        <div class="col-lg-4 col-sm-12company-logos logos" >
                        <img src="{{$setting->footer_image2}}" alt="alibaba"style="width: 80%;height: 52.5px;">
                        </div>
                        <div class="col-lg-4 col-sm-12 company-logos logos">
                        <img src="{{$setting->footer_image3}}" alt="alibaba"style="width: 80%;height: 52.5px;"  >
                        </div>
            ...
            <div class="">
              <div class="" style="color: #efefef;">
                ...
                <p class="" style="color: #efefef;">
                  <a class="link-underline"  href="{{route('home.index')}}"> STUDIO ALL IN</a>
