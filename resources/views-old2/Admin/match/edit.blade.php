                    ...
                    <div class="card-body">
                        ...
                        <form class="floating-labels m-t-40" action="{{route('admin.match.update',$match->id)}}" method ="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group m-b-40">
                                ...
                                <input type="text" class="form-control" id="exampleInputuname1" name="odds" value="{{$match->odds}}">
                                <label for="exampleInputuname1">odds</label>
                            </div>
                            <div class="form-group m-b-40">
                                
                                <input type="url" class="form-control" id="exampleInputuname1" name="submit_link" value="{{$match->submit_link}}">
                                <label for="exampleInputuname1">Submit link</label>
                            </div>
                            <div class="form-group m-b-40">
                                <div class="checkbox checkbox-success ">
                                    <input id="checkbox1" type="checkbox" name="api"class="form-control"{{$match->api==1?'checked':''}}>
