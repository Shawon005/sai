            ...
            <div class="col-lg-4">
              ...
              <div class="block-aside">
                ...
                <div class="block-aside-item">
                  ...
                  <article class="heading-component">
                    <div class="heading-component-inner">
                      <h5 class="heading-component-title">In The Övriga nyheter
                  ...
                  <div class="list-post-classic">
                    ...
                    <article class="post-classic">
                      <div class="post-classic-aside"><a class="post-classic-figure" href="{{route('home.blog',$blog->news_slug)}}"><img src="{{$blog->news_image}}" alt="" width="94" height="94"/></a></div>
