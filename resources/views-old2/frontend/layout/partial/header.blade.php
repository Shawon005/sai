                    ...
                    <li class="rd-nav-item1"> 
                      <div class="btn-group dropdown1">
                        ...
                        <ul class="dropdown-menu" style="--bs-dropdown-link-active-bg:#64b000;--bs-dropdown-link-hover-bg:#64b000;">
                          ...
                          <li class="dropdown-item {{ Request::is('speltip*') ? 'active' : '' }}"><a class="rd-nav-link" href="{{route('home.speltip')}}">Poolspel - Analys</a></li>
                          <li class="dropdown-item {{ Request::is('poolspel-analys*') ? 'active' : '' }}"><a class="rd-nav-link" href="{{route('home.speltips_g')}}"></a>Speltips</li>
