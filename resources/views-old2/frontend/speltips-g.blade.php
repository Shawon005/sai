          ...
          @foreach($matchspel as $match)
            <div class="col-lg-6 ">  
              ...
              <article class="card-details2 table_body" style="border: unset;">
                ...
                <div class="row " style="margin-top:-5px; padding:20px;height: 280px;">
                  <div class="col-lg-4">
                    
                    <div class="post-miranda-aside"><img src="{{$match->image}}" alt="" width="100%"style="height: 150px;" class="rounded-circle"/></div>
