      ...
      <section class="section section-sm bg-gray-100">
        <div class="container">
          ...
          <div class="row row-30">
            ...
            <div class="col-lg-4">
              <article class="post-corporate card-details"> 
                <div>
                ...
                <div class="text-center">
                  <h4>{{$tipspel->fullname}} </h4> <span class="text">"{{$tipspel->nickname}}"</span><br>
                  {!! Str::limit($tipspel->details,65) !!}
                      <span class="read-button"><a class="read-button" href="{{route('home.tipspel.details',$tipspel->id)}}">read more</a></span>
                </div>
              </article>
            </div>
            @endforeach
