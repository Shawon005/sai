        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="alert alert-success">
                 ...
                 @endif
                <h4 class="card-title"> SPELTRUPPEN</h4>
                <h6 class="card-subtitle">All SPELTRUPPEN Information</h6>
                <a  class="btn btn-info btn-rounded m-t-10 float-right" href="{{route('admin.tipspel.create')}}">Add New SPELTRUPPEN</a>
