<header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <!-- ============================================================== -->
                <!-- Logo -->
                @php $user=users(); $setting=setting(); @endphp
                <!-- ============================================================== -->
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{route('admin.dashbord')}}">
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{$setting->header_logo_b}}" weight="40px" height="40px" alt="homepage" class="dark-logo" />
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{table('admin','id',session('id'),'profile_image')}}" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="{{table('admin','id',session('id'),'profile_image')}}" alt="user"></div>
                                            <div class="u-text">
                                                <h4>{{table('admin','id',session('id'),'name')}}</h4>
                                                <p class="text-muted">{{table('admin','id',session('id'),'email')}}</p><a href="{{route('admin.profile')}}" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
