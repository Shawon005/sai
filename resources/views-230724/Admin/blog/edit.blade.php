                    ...
                    <div class="card-body">
                        ...
                        <form class="floating-labels m-t-40" action="{{route('admin.blog.update',$blog->blog_id)}}" method ="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group m-b-40">
                                ...
                                <label for="exampleInputuname2">Thumbnail</label>
                            </div> 
                            <div class="form-group m-b-40">
                                
                                <input type="file" class="form-control text-right" id="exampleInputuname2" name="banner_image">
                                <label for="exampleInputuname2">Banner Image</label>
                            </div> 
                            <div class="form-group m-b-40">
                                
                                <input type="text" class="form-control" id="exampleInputuname1" name="banner_link"value="{{$blog->banner_link}}" >
