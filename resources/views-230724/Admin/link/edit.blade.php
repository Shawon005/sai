                    ...
                    <div class="card-body">
                        ...
                        <form class="floating-labels m-t-40" action="{{route('admin.link.update',$link->id)}}" method ="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group m-b-40">
                                ...
                                <input type="text" class="form-control" id="exampleInputuname1" name="title" value="{{$link->title}}" >
                            ...
                            <div class="form-group m-b-40">
                                ...
                                <input type="description" class="form-control" id="exampleInputuname1" name="description"value="{{$link->description}}" >
                                <label for="exampleInputuname1">Description</label>
                            </div>
                            <div class="form-group m-b-40">
                                
                                <input type="text" class="form-control" id="exampleInputuname1" name="btn_text" value="{{$link->btn_text}}" >
                                <label for="exampleInputuname1">Bottom Text</label>
                            </div>
                            <div class="form-group m-b-40">
                                
                                <input type="text" class="form-control" id="exampleInputuname1" name="btn_link" value="{{$link->btn_link}}" >
