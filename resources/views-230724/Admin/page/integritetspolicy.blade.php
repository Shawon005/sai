  ...
  <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Integritetspolicy Layout</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('admin.dashbord')}}">Home</a></li>
                    <li class="breadcrumb-item">Integritetspolicy Layout</li>
                    <li class="breadcrumb-item active">Integritetspolicy Details</li>
                </ol>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Integritetspolicy Layout</h4>
                        <form class="floating-labels m-t-40" action="{{route('admin.spelansvar.update',12)}}" method ="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
