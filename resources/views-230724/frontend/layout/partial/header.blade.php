              ...
              <div class="rd-navbar-panel-inner container">
                <div class="rd-navbar-panel-item rd-navbar-panel-item-left">
                  <ul class="list-inline list-inline-sm">
                    ...
                    <li class="{{ Request::is('contact*') ? 'active' : '' }}"><a class="link link-classic " href="{{route('home.contact')}}">KONTAKT</a></li>
                  </ul>
                </div>
                <div class="rd-navbar-collapse rd-navbar-panel-item rd-navbar-panel-item-right">
                  <ul class="list-inline list-inline-bordered social-links">
                    ...
                    <li><a class="icon icon-corporate text-white fa fa-youtube" target="_blank" href="{{$setting->youtube}}"></a></li>
                    ...
                    <li class="rd-nav-item1"> 
                      <div class="btn-group dropdown1">
                        ...
                        <ul class="dropdown-menu" style="--bs-dropdown-link-active-bg:#64b000;--bs-dropdown-link-hover-bg:#64b000;">
                          ...
                          <li class="dropdown-item {{ Request::is('poolspel') ? 'active' : '' }}"><a class="rd-nav-link" href="{{route('home.poolspel')}}">Poolspel - Guide</a></li>

                          <li class="dropdown-item {{ Request::is('poolspel-analys') ? 'active' : '' }}"><a class="rd-nav-link" href="{{route('home.speltip')}}">Poolspel - Analys</a></li>
                          <li class="dropdown-item {{ Request::is('speltip*') ? 'active' : '' }}"><a class="rd-nav-link" href="{{route('home.speltips_g')}}">Speltips</a></li>
