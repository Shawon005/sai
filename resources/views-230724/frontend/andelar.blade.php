          ...
          <div class="row row-30 ">
            ...
            <div class="col-lg-4">
              <div class="card-details3 table_body" >
                <div class="row card-hd"style="background-color: #383838;">
                  <div class="col-4" >
                ...
                <div class="sub_andela">
                    <div class="row  custom table_body1" style="background-color: {{table('games','id',$sub_andelar->type,'color')}};">
                      <div class="col-4">
                        <img src="{{table('games','id',$sub_andelar->type,'logo')}}" alt="" class="custom-img">
                      </div>
                      <div class="col-8">
