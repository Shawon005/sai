@extends('frontend.layout.master')
  @section('content')
      ...
      <section class="section section-sm bg-gray-100">
        <div class="container">
          <div class="row row-60">
            ...
            <div class="col-lg-6 right"style="min-height:180px;">
                  ...
                  <div class="banner-inner">
                    ...
                    <div class="banner-body">
                      <div class="banner-content">
                        ...
                        <p class="banner-text banner-text-with-quote">{{$link->description}}</p>
                      </div>
                    </div>
                  </div>
                </a>
                  ...
                  <div class="banner-inner">
                    ...
                    <div class="banner-body">
                      <div class="banner-content">
                        ...
                        <p class="banner-text">{{$link->description}}</p>
                      </div>
                    </div>
                  </div>
                </a>
            ...
            <div class="col-lg-6"style="min-height:180px;">
              <article class="banner context-dark">
                <a href="{{$link->btn_link}}">
                  <div class="banner-inner">
                    <div class="banner-image"><img src="{{$link->image}}" alt="" width="769" height="366"/>
                ...
                <div class="post-miranda-content">
                  <div class="post-miranda-main">
                    <div class="post-miranda-header">
                      ...
                      <time class="post-miranda-time" datetime="2022">{{dateFormatconverter($blog->blog_cdt)}}
                      </time>
                      <div class="post-miranda-view"><span class="">{{user($blog->user_id)}}</span>
                      </div>
                    </div>
                    <h4 class="post-miranda-title"><a href="{{route('home.blog',$blog->blog_slug)}}">{{$blog->blog_name}}</a></h4>
                    <div class="post-miranda-text">
                      <p>{{ Str::limit(strip_tags($blog->blog_description),300) }}</p>
                    </div>
                  </div>
                  <div class="post-miranda-aside"><a class="post-miranda-figure" href="{{route('home.blog',$blog->blog_slug)}}"><img src="{{$blog->blog_image}}" alt="" width="207" height="152"style="max-height:192px"/></a></div>
                </div>
                <div class="post-miranda-footer">
                  <!-- <div class="post-miranda-comment"><span class="icon mdi mdi-comment-outline"></span><a href="{{route('home.blog',$blog->blog_slug)}}">Comments</a></div> -->
      ...
      <section class="section section-sm bg-gray-100">
        <div class="container">
          <div class="row row-30">
            <div class="col-lg-12 company-logos">
              <article class="post-miranda ">
