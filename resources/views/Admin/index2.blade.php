                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block">
                                ...
                                <div class="align-self-center">
                                    <h6 class="text-muted m-t-10 m-b-0">Total OM VÅR MEDIA</h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block">
                                ...
                                <div class="align-self-center">
                                    <h6 class="text-muted m-t-10 m-b-0">Total Nyheter</h6>
                ...
                <div class="col-lg-4">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="stats">
                                    <h1 class="text-white text-uppercase">Nyheter</h1>
                ...
                <div class="col-lg-4">
                    <div class="card bg-primary text-white">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="stats">
                                    <h1 class="text-white text-uppercase">TABLÅ</h1>
                ...
                <div class="col-lg-4">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="stats">
                                    <h1 class="text-white text-uppercase">OM VÅR MEDIA</h1>
                ...
                <div class="col-lg-4">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="stats">
                                    <h1 class="text-white text-uppercase">Speltips</h1>
                                    <!--<h6 class="text-white">Twitter Followers</h6>-->
                ...
                <div class="col-lg-4">
                    <div class="card bg-primary text-white">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="stats">
                                    <h1 class="text-white text-uppercase">Andelar</h1>
                                    <!--<h6 class="text-white">Facebook Likes</h6>-->
                ...
                <div class="col-lg-4">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="stats">
                                    <h1 class="text-white text-uppercase">SPELTRUPPEN</h1>
                                    <!--<h6 class="text-white">Subscribe</h6>-->
                                    <a href="{{route('admin.tipspel.index')}}" class="btn btn-rounded btn-outline btn-light m-t-10 font-14">View list</a>
                                </div>
                                <div class="stats-icon text-right ml-auto"><i class="fas fa-bars display-5 op-3 text-dark"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="stats">
                                    <h1 class="text-white text-uppercase">Match/Event</h1>
                                    <!--<h6 class="text-white">Twitter Followers</h6>-->
                ...
                <div class="col-lg-4">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="stats">
                                    <h1 class="text-white text-uppercase">Poolspel</h1>
                                    <!--<h6 class="text-white">Subscribe</h6>-->
                                    <a href="{{route('admin.poolspel.index')}}" class="btn btn-rounded btn-outline btn-light m-t-10 font-14">View list</a>
                                </div>
                                <div class="stats-icon text-right ml-auto"><i class="fas fa-align-right display-5 op-3 text-dark"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
