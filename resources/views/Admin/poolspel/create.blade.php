                    ...
                    <div class="card-body">
                        ...
                        <form class="floating-labels m-t-40" action="{{route('admin.poolspel.store')}}" method ="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group m-b-40">
                                ...
                                <!-- <input type="description" class="form-control" id="exampleInputuname1" name="contain1"> -->
                                <label for="exampleInputuname1">contain</label><br><br>
                                <textarea id="mymce" name="contain1"></textarea>
                            </div>
                            <div class="form-group m-b-40">
                                
                                <!-- <input type="description" class="form-control" id="exampleInputuname1" name="contain2" > -->
                                <label for="exampleInputuname1">contain</label><br><br>
                                <textarea id="mymce1" name="contain2"></textarea>
                            </div>
                            <div class="form-group m-b-40">
