  ...
  <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Ny Tipster</h4>
                      
                        <form class="floating-labels m-t-40" action="{{route('admin.andelar.update',$andelar->id)}}" method ="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
