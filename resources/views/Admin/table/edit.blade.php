                    ...
                    <div class="card-body">
                        ...
                        <form class="floating-labels m-t-40" action="{{route('admin.table.update',$table->id)}}" method ="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group m-b-40">
                                ...
                                <input type="text" class="form-control" id="exampleInputuname1" name="title"  value="{{$table->title}}" >
                            ...
                            <div class="form-group m-b-40">
                                ...
                                <select name="category" id="inlineFormCustomSelect"class="custom-select col-12 m-b-40">
                                    ...
                                    <option value="PODD"{{($table->category=='PODD')?'selected':''}}>PODD</option>
                            ...
                            <input type="file" id="input-file-now-custom-1" name="image" class="dropify" data-default-file="{{$table->image}}" />
                                ...
                                <small class="text-danger">Image Should be 287x150</small>
                            </div> 
                            <div class="form-group m-b-40">
                            ...
                            <div class="form-group m-b-40 ">
                                ...
                                <input type="datetime-local" class="form-control" id="exampleInputuname1" name="cdt"  value="{{$table->cdt}}">
